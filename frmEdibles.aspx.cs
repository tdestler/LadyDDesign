...
public partial class Forms_frmEdibles : System.Web.UI.Page
{
    ...
    protected void btnSubmitCard_Click(object sender, EventArgs e)
    {
        ...
        DS = clsDataLayer.GetOrderProduct(162);
        ...
        product.ItemLongDesc = " Edible Delivery Date: " + txtEdiblesDeliveryDate + " Custom Order: " + txtEdibleTheme.Text;
